...
const USE_ROBUST_AS_PRIMARY = true; // Use robust parser first, not as fallback
...
if (typeof RobustResumeParser !== 'undefined' && USE_ROBUST_PARSER) {
  ...
  console.log('[Parser] Robust parser initialized and ready' + (USE_ROBUST_AS_PRIMARY ? ' as PRIMARY' : ' as fallback'));
}
...
function parseResumeText(text) {
  ...
  // USE ROBUST PARSER FIRST if enabled
  ...
  // If current parser failed and robust parser is available, use it as fallback
