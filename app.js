...
// Version 2.6 - Distinguish job header bullets vs achievement bullets
...
if (typeof RobustResumeParser !== 'undefined' && USE_ROBUST_PARSER) {
  ...
  console.log('[Parser v2.6] Robust parser initialized' + (USE_ROBUST_AS_PRIMARY ? ' as PRIMARY' : ' as fallback'));
}
